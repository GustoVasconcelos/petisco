<div class="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark" style="min-height: 100vh;">
    <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-4 text-white">
        ...
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start w-100 mt-3" id="menu">
            ...
            <li class="nav-item w-100"><a href="{{ url('/admin/animais') }}" class="nav-link text-white px-3"><i class="bi bi-heart-fill me-2 text-danger"></i> <span class="d-none d-sm-inline">Animais</span></a></li>
            <li class="nav-item w-100"><a href="{{ url('/admin/historico') }}" class="nav-link text-white px-3"><i class="bi bi-journal-medical me-2"></i> <span class="d-none d-sm-inline">Histórico</span></a></li>
            ...
            <li class="nav-item w-100"><a href="{{ url('/admin/servicos') }}" class="nav-link text-white px-3"><i class="bi bi-scissors me-2"></i> <span class="d-none d-sm-inline">Serviços</span></a>
</li>
